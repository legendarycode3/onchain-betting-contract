...
* ****`resolveBetAndPayout()`****: Allows the arbiter to determine the winner and transfer the entire betting pot to them. This function allows the designated arbiter to determine the outcome of the wager or bet
