...
Purpose: </br> 
Ensures the `OnchainBetting.sol` contract functions correctly, securely, and as intended by validating staking flows, bet resolution, payouts, refunds, permissions,
