...
* ****Automated Market Maker (AMM) Betting:**** Instead of matching bettors against each other, liquidity providers deposit funds into betting pools. Users then place bets against the pool itself. This model mirrors DeFi protocols where liquidity providers
