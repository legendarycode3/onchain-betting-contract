...
* ****`s_totalPot`****: Total amount of ETH currently held in the betting pool. The value increases whenever a participant stakes the required wager amount and decreases when funds are refunded or distributed. At the time of resolution, the full
