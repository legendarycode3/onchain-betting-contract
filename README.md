...
### Variables:
* ****`i_player1`****: Stores the address of the first betting participant. This address is supplied during contract deployment and cannot be modified afterward due to the
