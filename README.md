...
* ****Transparency and Verifiability:**** Every transaction in an onchain betting system is recorded on a blockchain: Bets placed are visible, odds logic (if coded onchain) is inspectable
